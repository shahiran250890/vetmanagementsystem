...
class StaffFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'preferred_name' => null,
            'nric_passport' => null,
            'gender' => fake()->optional(0.75)->randomElement(['1', '2']),
            'date_of_birth' => fake()->optional(0.55)->date(),
            'nationality' => fake()->optional(0.65)->randomElement([
                'Malaysia',
                'Singapore',
                'Indonesia',
                'Brunei Darussalam',
            ...
            'marital_status' => fake()->optional(0.6)->randomElement(['single', 'married']),
            'photo_path' => null,
