  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'bg-background fixed z-50 flex flex-col gap-4 shadow-xl transition-transform duration-300 ease-out',
          side === 'right' && 'inset-y-0 right-0 h-full w-[min(100%,20rem)] translate-x-0 border-l sm:max-w-sm',
          side === 'left' && 'inset-y-0 left-0 h-full w-[min(100%,20rem)] border-r sm:max-w-sm',
